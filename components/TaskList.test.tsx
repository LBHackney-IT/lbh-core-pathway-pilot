...
describe("Task List Component Tests", () => {
  ...
  it("should show a theme if the filterType matches the workflow type", () => {
    expect(screen.getAllByText("1. Mock theme")).not.toBe(null)
  })
  it("should not show a theme if there is no filterType", () => {
    expect(screen.queryByText("3. Mock theme 3")).toBe(null)
  })
  it("should show a theme if there are multiple filterTypes and one of them matches the workflow type", () => {
